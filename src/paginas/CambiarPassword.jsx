        ...
        <div className="flex justify-center">
            ...
            {msg && <Alerta estaEsmiAlerta={alerta} />}
                <form onSubmit={handleSubmit}>
                    <div className="my-3">
                        <label htmlFor="password" className="uppercase font-bold text-gray-600">Password</label>
                        <input type="password"
                    ...
                    <input 
                        ...
                        className="bg-indigo-700 px-10 py-3 font-bold text-white rounded-lg uppercase w-full mt-5 text-center"/>
                </form>
            </div>
        </div>
