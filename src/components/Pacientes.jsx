...
const Pacientes = ({paciente}) => {
    ...
    const formatearFecha = () => {
        ...
        return new Intl.DateTimeFormat('es-MX',{dateStyle:'long'}).format(fechaNueva)
    }
    ...
    return (
        <div className="mx-5 my-10 bg-white shadow-md px-5 py-10 rounded-xl">
            ...
            <p className="font-bold uppercase text-indigo-700 my-2">Fecha Alta: <span className="font-normal normal-case text-black">{formatearFecha(fecha)}</span></p>
